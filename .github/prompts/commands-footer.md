<!-- Managed by lenaxia/ai-workflows@v0.2.7 — do not edit. Override via consumers/<repo>.yaml. -->
...
| `/security [text]` | Security-focused review (credentials, packet handling, input validation, concurrency). |
