...
These rules apply to every response. They are non-negotiable.{{ block "preamble_extra" . }}{{ end }}
...
{{ block "assumptions_extra" . }}{{ end }}
{{ block "project_rules" . }}{{ end }}
### Zero Technical Debt
