...
| `/security [text]` | Security-focused review. Checks credentials, packet handling, input validation, concurrency. Fixes findings if code changes are warranted. | Optional |
